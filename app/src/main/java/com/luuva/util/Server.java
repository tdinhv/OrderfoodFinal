...
public class Server {
    ...
    public  static String Duongdantatcadanhmuc ="https://lebavy1611.000webhostapp.com/getlistcat.php";
    public  static String Duongdansanphamtheodanhmuc ="https://lebavy1611.000webhostapp.com/getFoodByIDCat.php";
